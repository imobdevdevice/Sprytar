...
//		$("#radarContainer").click(PoiRadar.clickedRadar);
		...
		World.markerDrawable_idle = new AR.ImageResource("assets/sprytar_idle.png");
		World.markerDrawable_selected = new AR.ImageResource("assets/sprytar_idle.png");
...
//			if (World.markerList[i].distanceToUser <= 5) {
//                var architectSdkUrl = "architectsdk://showlookscreen";
