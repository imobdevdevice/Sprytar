...
import com.novp.sprytar.events.GeofenceTransitionsEvent;
...
public class GeofenceTransitionsIntentService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        if (geofenceTransition == Geofence.GEOFENCE_TRANSITION_ENTER ||
            ...
            Timber.i(TAG, geofenceTransitionDetails);
        } else {
            // Log the error.
    ...
    private void sendNotification(List<Geofence> triggeringGeofences) {
        ...
        eventBus.post(new GeofenceTransitionsEvent(triggeringGeofences));
