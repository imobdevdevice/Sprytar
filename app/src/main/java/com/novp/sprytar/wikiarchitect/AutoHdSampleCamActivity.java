...
public class AutoHdSampleCamActivity extends SampleCamActivity {
    private static final String LATITUDE_EXTRA = "com.novp.sprytar.game.latitudeExtra";
    private static final String LONGITUDE_EXTRA = "com.novp.sprytar.game.longtitudeExtra";
