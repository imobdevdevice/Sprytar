...
import com.novp.sprytar.databinding.ActivityRegisterBinding;
...
public class RegisterActivity extends BaseActivity implements RegisterView {
  ...
  public static final String POSTCODE_EXTRA = "com.novp.sprytar.login.PostcodeExtra";
  ...
  public void onRegisterClick(View view) {
    if (!validEmail || !validPassword || !validPasswordLengh) {
      ...
      presenter.registerUser(binding.emailEditText.getText().toString(), binding.passwordEditText.getText().toString(),
