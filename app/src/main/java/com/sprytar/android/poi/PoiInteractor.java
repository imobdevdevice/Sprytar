...
public class PoiInteractor extends Interactor {

    private final DataRepository dataRepository;

    @Inject
    public PoiInteractor(@Named(RxModule.IO) Scheduler workScheduler,
                         @Named(RxModule.MAIN) Scheduler mainScheduler, DataRepository
                                              repository) {
