...
import com.sprytar.android.databinding.ActivityPoiBinding;
import com.sprytar.android.databinding.PoiPlayerViewBinding;
import com.sprytar.android.poi.DaggerPoiComponent;
...
public class PoiActivity extends BaseActivity
  ...
  public static final String POI_EXTRA = "com.sprytar.android.poi.PoiExtra";
  public static final String AMENITY_EXTRA = "com.sprytar.android.poi.AmenityExtra";
  ...
  @Override public void showAmenity(Amenity amenity) {
    ...
    showDescription(amenity.getDescription());
  ...
  private void showDescription(String description) {
    ...
    if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.N) {
      binding.descriptionTextView.setText(Html.fromHtml(description,Html.FROM_HTML_MODE_LEGACY), TextView.BufferType.SPANNABLE);
    } else {
      binding.descriptionTextView.setText(Html.fromHtml(description), TextView.BufferType.SPANNABLE);
    }
  }
  ...
  @Override public void showPoi(PointOfInterest poi) {
    ...
    binding.setPoi(poi);
    showDescription(poi.getDescription());
