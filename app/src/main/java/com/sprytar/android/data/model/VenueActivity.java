...
import com.sprytar.android.domain.GameRuleListParcelConverter;
import com.sprytar.android.domain.QuestionListParcelConverter;
import com.sprytar.android.domain.VenueActivityDetailListParcelConverter;
...
public class VenueActivity extends RealmObject {
    ...
    // Update : 07/09/2017
    // New paramters added in response

    @SerializedName("game_intro_text")
    @Expose
    private String introText;

    @SerializedName("game_start_location_text")
    @Expose
