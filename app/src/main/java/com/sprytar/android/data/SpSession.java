package com.sprytar.android.data;
...
public class SpSession {
    private static final String PREF_NAME = "com.sprytar.android.data.SessionManager";
    ...
    public void createSession(AuthUser authUser) {
        ...
        editor.putInt(IS_SUPER_USER,authUser.getIs_superuser());
    ...
    public int isSuperUser(){
        return pref.getInt(IS_SUPER_USER, 0);
    }
